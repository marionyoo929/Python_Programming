# 문자열 내장 함수 # 문자열 내장 - (문자열).함수, 파이썬 내장 - 그냥 쓰는 함수
...
# print(s.index("Java"))            # 인덱스 반환 ( 없으면 에러 남 )

# 부분 문자열이 몇 번 나오는지 알려주는 문자열 메소드
print(s.count("o"))                 # 등장 횟수

# 문자열 포함여부를 알려주는 멤버십 연산자 - 매소드가 아니라 연산자임 !!
print("Python" in s)                # 포함(True)
print("Java" in s)                  # 미포함(False) - "Java" not in s 는 True임
...
print(s.replace("Ptrhon", "C", 1))  # 1개만 치환 - 2면 두 개 ...
...
print("abcd@dimigo.hs.kr" in email)            # ✅ "@dimigo.hs.kr"이 포함되어 있으면 True
